  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section ref={heroRef} className="relative overflow-hidden">
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="max-w-6xl mx-auto px-6 pt-24 pb-32 sm:pt-32 sm:pb-40">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-7xl font-semibold tracking-tight leading-[1.05] max-w-4xl"
          >
      ...
      <section className="border-t border-border/40">
        <div className="max-w-6xl mx-auto px-6 py-24 sm:py-32 grid sm:grid-cols-12 gap-10">
          ...
          <motion.div {...fadeUp} className="sm:col-span-8 space-y-8">
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 sm:py-32">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-border/60 border border-border/60 rounded-2xl overflow-hidden">
            {modules.map((m, i) => (
              ...
              >
                <m.icon className="h-5 w-5 mb-6" strokeWidth={1.5} />
            ...
            >
              <Sparkles className="h-5 w-5 mb-6" strokeWidth={1.5} />
          ...
          <div className="space-y-px">
            {steps.map((s, i) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: i * 0.05 }}
                className="grid sm:grid-cols-12 gap-6 py-8 border-t border-border/60 first:border-t-0"
              >
      ...
      <section id="trust" className="border-t border-border/40 bg-muted/20">
        <div className="max-w-6xl mx-auto px-6 py-24 sm:py-32 grid sm:grid-cols-3 gap-10">
          {[
            ...
            >
              <t.icon className="h-5 w-5 mb-6" strokeWidth={1.5} />
      ...
      {/* CTA */}
      <section className="border-t border-border/40">
        <div className="max-w-6xl mx-auto px-6 py-32 sm:py-40 text-center">
          <motion.h2 {...fadeUp} className="text-4xl sm:text-6xl font-semibold tracking-tight leading-[1.05] max-w-3xl mx-auto">
            See Udyami running on your own production data.
          </motion.h2>
          <motion.p {...fadeUp} className="mt-8 text-lg text-muted-foreground max-w-xl mx-auto">
