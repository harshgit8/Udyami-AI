...
Web application for the Udyami - an L1 cache for your LLMs.

## Overview

The Udyami frontend is a Next.js-based web application that serves as the primary user interface for uploading, managing, and accessing processed content.
...
- **Udyami Backend**: Running FastAPI service 
...
```bash
git clone https://github.com/inclinedadarsh/Udyami.git
cd Udyami/frontend
```
...
- `BACKEND_URL`: URL of the running Udyami backend (default: `http://localhost:8000`)

### 4. Verify Backend Connection

Ensure the Udyami backend service is running and accessible at the URL specified in `BACKEND_URL`.
...
This project is part of the Udyami ecosystem. Please refer to the root repository for license information.
