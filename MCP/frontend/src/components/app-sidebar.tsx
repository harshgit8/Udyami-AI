      ...
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem className="flex items-center gap-2 p-2 rounded-md border-sidebar-border border">
            <div className="bg-gradient-to-r from-orange-500 to-yellow-500 flex aspect-square size-8 items-center justify-center rounded-lg">
              <span className="text-white font-bold text-sm">U</span>
            </div>
            <div className="flex flex-col gap-0.5 leading-none">
              <span className="font-semibold text-lg">Udyami AI</span>
            </div>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarHeader>
