...
# Get uploads directory from environment variable or calculate relative path
uploads_base = os.getenv("UPLOADS_BASE_DIR")
if uploads_base:
    BASE_DIR = Path(uploads_base).resolve()
else:
    # Fallback: Uploads directory is one level up from project root (adjacent to project)
    BASE_DIR = (
